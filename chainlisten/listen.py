...
web3 = Web3(Web3.HTTPProvider(mumbai), middlewares=[])
...
print('Latest block:', web3.eth.blockNumber)
#print(contract.functions.exists(1).call())
...
def main():
    event_filter = contract.events.TransferSingle.createFilter(fromBlock='latest')
