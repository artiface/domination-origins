...
if __name__ == "__main__":
    ...
    def run():
        ...
        # Basic Settings
        network_rpc_url = 'https://matic-mumbai.chainstacklabs.com'
        address = '0xB3f5900562b8944025e7303CD6B0520a42599513'
        ...
        start_block = 26395546 # contract creation block

        # Load contract
        web3 = Web3(Web3.HTTPProvider(network_rpc_url), middlewares=[])
