...
WEB_ASSETS_DIRECTORY = os.path.abspath(os.path.join(os.path.dirname(__file__), '..', 'assets'))
TOKEN_DATA_DIRECTORY = os.path.abspath(os.path.join(os.path.dirname(__file__), '..', 'token_data'))
