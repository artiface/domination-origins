...
pfw = random.choice([1, 2, 4, 8])
pfh = random.choice([1, 2, 4, 8])
step = random.uniform(0.0001, 0.15)
draw(1920, 1080, color=color, perlinFactorW=pfw, perlinFactorH=pfh, step=step)